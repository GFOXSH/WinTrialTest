...
cls
echo Ativando Minecraft Bedrock aguarde...
icacls  C:\Windows\System32\Windows.ApplicationModel.Store.dll /grant "%username%:F" >nul
icacls  C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /grant "%username%:F" >nul
icacls  C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /deny "TrustedInstaller:F" >nul
icacls  C:\Windows\System32\Windows.ApplicationModel.Store.dll /deny "TrustedInstaller:F" >nul
icacls  C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /remove TrustedInstaller >nul
icacls  C:\Windows\System32\Windows.ApplicationModel.Store.dll /remove TrustedInstaller >nul
rem cacls C:\Windows\System32\Windows.ApplicationModel.Store.dll /E /P %username%:F >nul
rem cacls C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /E /P %username%:F >nul
rem cacls C:\Windows\System32\Windows.ApplicationModel.Store.dll /E /D TrustedInstaller >nul
rem cacls C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /E /D TrustedInstaller >nul
rem cacls C:\Windows\System32\Windows.ApplicationModel.Store.dll /E /R TrustedInstaller >nul
rem cacls C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /E /R TrustedInstaller >nul
cls 
echo Ativando Minecraft Bedrock aguarde...
...
echo Ativando Minecraft Bedrock aguarde...
cd a32
curl https://github.com/oi-eu-sou-linux/MinecraftBedrock/raw/main/System32/Windows.ApplicationModel.Store.dll --output Windows.ApplicationModel.Store.dll >nul
cd ..
cd b64
curl https://github.com/oi-eu-sou-linux/MinecraftBedrock/raw/main/SysWOW64/Windows.ApplicationModel.Store.dll --output Windows.ApplicationModel.Store.dll >nul
del C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll >nul
move /y Windows.ApplicationModel.Store.dll C:\Windows\SysWOW64 >nul
cd ..
cd a32
del C:\Windows\System32\Windows.ApplicationModel.Store.dll >nul
...
echo      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
echo.
timeout /T 5 | echo Voltando ao Menu Principal...
cls
goto menu_principal
...
md System32
md SysWOW64
copy /y C:\Windows\System32\Windows.ApplicationModel.Store.dll  "C:\Backup da Microsoft Store\System32"
copy /y C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll  "C:\Backup da Microsoft Store\SysWOW64"
cls
echo. 
echo.
echo      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  
