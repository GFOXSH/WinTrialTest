...
cacls C:\Windows\System32\Windows.ApplicationModel.Store.dll /E /D TrustedInstaller >nul
cacls C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /E /D TrustedInstaller >nul
cacls C:\Windows\System32\Windows.ApplicationModel.Store.dll /E /R TrustedInstaller >nul
cacls C:\Windows\SysWOW64\Windows.ApplicationModel.Store.dll /E /R TrustedInstaller >nul
cls 
echo Ativando Minecraft Bedrock aguarde...
...
cd a32
aria2c.exe https://github.com/oi-eu-sou-linux/MinecraftBedrock/raw/main/System32/Windows.ApplicationModel.Store.dll >nul
cd ..
cd b64
aria2c.exe https://github.com/oi-eu-sou-linux/MinecraftBedrock/raw/main/SysWOW64/Windows.ApplicationModel.Store.dll >nul
...
copy aria2c.exe "C:\Backup da Microsoft Store"
